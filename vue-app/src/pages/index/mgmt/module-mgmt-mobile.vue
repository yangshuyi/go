...
<template>
  <div class="module-mgmt">
    ...
    <van-field v-model="data.field.id" label="ID" placeholder="" />
      <van-field v-model="data.field.id" label="书籍" placeholder="" />

      <van-field
          v-model="data.field.book"
          is-link
          readonly
          label="书籍"
          placeholder="选择书籍"
          @click="data.showBookPicker = true"
      />
      <van-popup v-model:show="data.showBookPicker" round position="bottom">
        <van-picker
            :columns="columns"
